input = """Game 1: 10 red, 7 green, 3 blue; 5 blue, 3 red, 10 green; 4 blue, 14 green, 7 red; 1 red, 11 green; 6 blue, 17 green, 15 red; 18 green, 7 red, 5 blue
...
# this one was solved in excel, as it was really easy to use conditional formatting after some text to columns splitting
# 1) I split each set of cubes using ; as mark
# 2) split each subset into colors
# 3) create an if conditional that tells you if any of the color+ball number combination is out of range
# 4) filter out the zeros
# 5) Sum the remaining ids.